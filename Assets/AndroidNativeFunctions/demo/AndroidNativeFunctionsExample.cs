...
public class AndroidNativeFunctionsExample : MonoBehaviour
{
    ...
    private void ShowAlertAction(DialogInterface w)
    {
        AndroidNativeFunctions.ShowToast(w.ToString());
    }

    private void ShowAlertInputAction(DialogInterface w, string t)
    {
        AndroidNativeFunctions.ShowToast(w.ToString() + " " + t);
    }

    private void ShowAlertListAction(string selectList)
    {
